...
finstack is used for investment research, and money makes people defensive.
Two things follow:

**Disagree with the analysis, not the person.** If you think a skill produces
bad reasoning, say why with a concrete example. "This is wrong" is not a bug
report; "judge accepted a bull case citing a margin figure that contradicts the
10-K" is.

**Do not give unsolicited investment advice in issues or discussions.** This
project builds a tool for thinking about investments. It is not a forum for
recommending positions, and treating it as one creates liability for everyone.
...
[GitHub's report abuse form](https://github.com/contact/report-abuse) or by
