...
describe('learnings', () => {
  ...
  it('appends and loads a learning', () => {
    appendLearning(
      { skill: 'sense', type: 'error', summary: 'Yahoo crumb expired', detail: '', tags: [] },
      TEST_FILE,
    );
  ...
  it('appends multiple learnings', () => {
    appendLearning(
      { skill: 'sense', type: 'error', summary: 'first', detail: '', tags: [] },
      TEST_FILE,
    );
    appendLearning(
      { skill: 'judge', type: 'insight', summary: 'second', detail: '', tags: [] },
      TEST_FILE,
    );
  ...
  it('searches by keyword', () => {
    ...
    appendLearning(
      { skill: 'judge', type: 'insight', summary: 'Good bull/bear balance', detail: '', tags: [] },
      TEST_FILE,
    );
  ...
  it('returns most recent first', () => {
    appendLearning(
      { skill: 'sense', type: 'error', summary: 'older', detail: '', tags: [] },
      TEST_FILE,
    );
    appendLearning(
      { skill: 'sense', type: 'error', summary: 'newer', detail: '', tags: [] },
      TEST_FILE,
    );
  ...
  it('respects limit', () => {
    for (let i = 0; i < 5; i++) {
      appendLearning(
        { skill: 'sense', type: 'error', summary: `item ${i}`, detail: '', tags: [] },
        TEST_FILE,
      );
    }
