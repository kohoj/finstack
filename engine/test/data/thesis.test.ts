    ...
    registerThesis(
      {
        ...
        conditions: [
          ...
          {
            description: 'No cloud capex cuts',
            type: 'event',
            falsificationTest: 'Is a top-4 cloud provider cutting AI capex >10%?',
    ...
    registerThesis(
      {
        ...
        verdict: 'buy',
        conditions: [
          { description: 'test', type: 'event', falsificationTest: 'test?', watchTickers: [] },
        ],
      },
      TEST_FILE,
    );
